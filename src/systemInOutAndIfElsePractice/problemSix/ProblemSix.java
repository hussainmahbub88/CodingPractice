package systemInOutAndIfElsePractice.problemSix;

import java.util.Scanner;

public class ProblemSix {
	/*
	 * Read an integer value. Assume it is the number of a month of the year; 
	...
	public static void main(String[] args) {
		...
		/*
		 * switch (month) { case 1: System.out.println("January"); break; case 2:
		 ...
		 * System.out.println("Invalid month"); } System.out.println("Your month is " +
		 * month);
		 */
	}
